...
public LinkedList<E> reverse() {
        return this.reverse(this.first);
    }

    private LinkedList<E> reverse(Node<E> var1) {
        if(var1 == null) {
            return new LinkedList();
        } else {
            LinkedList var2 = this.reverse(var1.next);
            var2.addLast(var1.elem);
            return var2;
        }
    }
